    ...
    <main className="min-h-screen bg-gray-50 px-6 py-8 text-zinc-900">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
        <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
          ...
          <h1 className="mt-2 text-3xl font-bold tracking-tight">Quick Resident Record Correction</h1>
        ...
        <section className="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm">
          <div className="mb-3 flex items-center justify-between">
            <h2 className="text-lg font-semibold">Update Resident Record by Resident</h2>
            <button
              type="button"
              onClick={() => {
                void onSaveAll();
                      ...
                      <td className="px-2 py-1">
                        <select
                          ...
                          onChange={(event) => {
                            ...
                            setRows((prev) =>
                              prev.map((item) => (item.id === row.id ? { ...item, gender: value } : item)),
                            );
                          }}
                          className="rounded border px-2 py-1"
                        >
